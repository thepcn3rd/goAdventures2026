...
Notes: This does not elevate privileges so if emulating the real GUP.exe process it does not generate the config.json file, logs directory and the results.log file.


This emulation creates a lot of noise on purpose!!!
**/
